<div>
    <div class="fixed top-0 left-0 z-[1050] w-screen h-screen bg-black/50 {{ $model_property }}"></div>
    <section  class="fixed left-0 top-0 z-[1055] h-full w-full overflow-y-auto overflow-x-hidden outline-none {{ $model_property }}">
