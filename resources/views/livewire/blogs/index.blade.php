<div class="p-3">
    ...
    <table class="table-auto border-collapse border border-blue-200 w-full">
        ...
        <tbody class="border border-blue-200">
            ...
            <tr>
                <td class="border border-blue-200 text-center">{{ $blog->id }}</td>
                ...
                <td class="border border-blue-200 text-center">{{ $blog->brand }}</td>
                <td class="border border-blue-200 text-center">{{ $blog->model }}</td>
                <td class="border border-blue-200 text-center">{{ $blog->vin }}</td>
                <td class="border border-blue-200 text-center">{{ $blog->registration }}</td>
                <td class="border border-blue-200 text-center">{{ $blog->fuel }}</td>
                <td class="border border-blue-200 text-center">
